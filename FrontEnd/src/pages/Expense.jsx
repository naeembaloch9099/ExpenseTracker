      ...
      <Main>
        ...
        <Content>
          ...
          >
            ...
            >
              <div>
                <h3 style={{ margin: 0 }}>Expense Overview</h3>
            ...
            <div style={{ width: "100%", overflowX: "auto", paddingBottom: 8 }}>
              <svg
                width={Math.max(700, expenses.length * 80)}
                height="220"
                style={{ minWidth: 700 }}
              >
                ...
                {[0, 3500, 7000, 10500, 14000].map((y, i) => (
                  <g key={i}>
                    <line
                      x1={60}
                      x2={Math.max(700, expenses.length * 80) - 20}
                      y1={200 - (y / 14000) * 180}
                      y2={200 - (y / 14000) * 180}
                      stroke="#eee"
                    />
                ...
                {expenses.slice(0, 10).map((exp, i) => (
                  <g key={exp.id}>
                    <rect
                      ...
                      y={
                        200 -
                        (Math.min(Math.abs(exp.amount), 14000) / 14000) * 180
                      }
                      width={40}
                      height={
                        (Math.min(Math.abs(exp.amount), 14000) / 14000) * 180
                    ...
                    >
                      ...
                      <tspan dx="8" dy="2" fontSize="15" fill="#ef4444">
          ...
          >
            <h3 style={{ margin: 0, marginBottom: 16 }}>Expense List</h3>
